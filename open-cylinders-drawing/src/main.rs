...
fn main() {
    ...
    let cyl_1 = ObjectBuilder::new_cylinder()
        .with_min(-cyl_len * 1.5)
        .with_max(cyl_len * 0.5)
        .with_cap(Cap::Uncapped)
        .with_material(
            Material::new()
    ...
    let cyl_2 = ObjectBuilder::new_cylinder()
        .with_min(-cyl_len * 2.0)
        .with_max(cyl_len * 4.0)
        .with_cap(Cap::Uncapped)
        .with_transform(
    ...
    let cyl_4 = ObjectBuilder::new_cylinder()
        .with_min(-cyl_len * 3.0)
        .with_max(cyl_len * 1.5)
        .with_cap(Cap::Uncapped)
    ...
    let cyl_5 = ObjectBuilder::new_cylinder()
        .with_min(-cyl_len * 1.0)
        .with_max(cyl_len * 1.0)
        .with_cap(Cap::Uncapped)
        .with_transform(
            Transformation::new_transform()
                .rotation_x(-PI / 2.0)
